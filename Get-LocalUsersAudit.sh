...
# RunId: default UTC YYYYMMDD (e.g. 20251217). Optional override via $1 (plain or {"RunId":"20251217"}).
arg1="${1:-}"
run_id=""
...
while ((${#queue[@]})); do
  ...
  while IFS= read -r raw; do
    ...
    # Ignore non-rule lines (NO '#include' here; that caused your syntax error)
    case "$first" in
